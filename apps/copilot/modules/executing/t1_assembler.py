...
from apps.copilot.modules.executing.storage import latest_raw_map, load_daily_bars
...
async def _calc_volume_price_div_live(
    ...
    *,
    ...
    cached = load_bars_15m_redis(redis_client, symbol) if redis_client else None
    payload = process_volume_price_div_from_redis(cached)
    return "volume_price_div", build_volume_price_div_node(payload)
